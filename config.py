...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "8193486523:AAFGu7sAwd5TABED65gJIiakEvN37qYKyq8")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "feng_uploader_bot") # Bot username without @.
